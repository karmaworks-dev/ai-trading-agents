# 🕉️ Karma Dev's Custom Strategies Directory
...
- Use Karma Dev's utility functions from nice_funcs.py
...
## Questions?
Check out the example strategy or reach out to Karma Dev for help! 🕉️ 🚀 