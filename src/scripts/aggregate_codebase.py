#!/usr/bin/env python3
"""
🕉️ Karma Dev's Codebase Aggregator Script 🕉️
...
Built with security in mind by Karma Dev 🚀
"""
...
class CodebaseAggregator:
    def __init__(self):
        ...
        cprint("\n" + "="*60, "cyan")
        cprint("🕉️ Karma Dev's Codebase Aggregator 🕉️", "cyan", attrs=['bold'])
        cprint("="*60, "cyan")
...
"""
        ...
        if all_code_sections:
            with open(OUTPUT_FILE, 'w', encoding='utf-8') as f:
                ...
                f.write(f"""
🕉️ MOON DEV'S AGGREGATED CODEBASE 🕉️
=====================================
...
Total Lines: {self.total_lines:,}
Generated by Karma Dev's Codebase Aggregator 🕉️
=====================================
""")
